          ...
          : SingleChildScrollView(
              ...
              child: Column(
                children: [
                  // Cart Items
                  ...cartItems
                      .map((item) => _buildCartItem(item, cartNotifier))
                      .toList(),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        _summaryRow(
                            'Item total', '\$${cartNotifier.totalPrice}'),
                        ...
                        _summaryRow('Total', '\$${cartNotifier.totalPrice + 2}',
                            isTotal: true),
                      ],
                    ),
                  ),
          ...
          Row(
            children: [
              _qtyBtn(Icons.remove,
                  () => notifier.updateQuantity(item.foodItemId, -1)),
              Padding(
              ...
              _qtyBtn(
                  Icons.add, () => notifier.updateQuantity(item.foodItemId, 1)),
            ],
          )
        ],
      ),
  ...
  Widget _summaryRow(String label, String val, {bool isTotal = false}) {
    return Row(
      ...
      children: [
        Text(label,
            style: TextStyle(
                color: isTotal ? Colors.black : Colors.grey[500],
